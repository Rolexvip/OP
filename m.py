...
bot = telebot.TeleBot('7391691912:AAFbgSVo6iKnVIGuldlmYbxAnKisfTjW2Ps')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: BUY FROM :- @YamrajjXOwner\nJOIN: https://t.me/+d1W__jw_gKVkYWE9"
    bot.reply_to(message, response)
...
Buy From :- @YamrajjXOwner
Official Channel :- https://t.me/+d1W__jw_gKVkYWE9
TEAM YAMRAJJ
'''
...
3. MAKE SURE YOU JOINED https://t.me/+d1W__jw_gKVkYWE9 OTHERWISE NOT WORK
