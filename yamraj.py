...
TOKEN = '7391691912:AAFbgSVo6iKnVIGuldlmYbxAnKisfTjW2Ps'
...
def attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "You are not approved to use this bot. Please contact the administrator @YamrajjXOwner")
            return
...
def attack_command(message):
    ...
    try:
        user_data = users_collection.find_one({"user_id": user_id})
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*You are not approved to use this bot. Please contact the administrator  @YamrajjXOwner*", parse_mode='Markdown')
            return
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*Attack started 💥\n\nHost: {target_ip}\nPort: {target_port}\nTime: {duration}\nJOIN :- https://t.me/+zJ-acAvFdCE0ZmQ9*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+zJ-acAvFdCE0ZmQ9*", parse_mode='Markdown')
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator.@YamrajjXOwner*"
